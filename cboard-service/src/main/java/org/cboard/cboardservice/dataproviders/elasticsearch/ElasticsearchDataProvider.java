package org.cboard.cboardservice.dataproviders.elasticsearch;
...
import org.cboard.cboardservice.cache.CacheManager;
import org.cboard.cboardservice.cache.HeapCacheManager;
import org.cboard.cboardservice.dataprovider.DataProvider;
import org.cboard.cboardservice.dataprovider.Initializing;
import org.cboard.cboardservice.dataprovider.aggregator.Aggregatable;
import org.cboard.cboardservice.dataprovider.annotation.DatasourceParameter;
import org.cboard.cboardservice.dataprovider.annotation.ProviderName;
import org.cboard.cboardservice.dataprovider.annotation.QueryParameter;
import org.cboard.cboardservice.dataprovider.config.*;
import org.cboard.cboardservice.dataprovider.result.AggregateResult;
import org.cboard.cboardservice.dataprovider.result.ColumnIndex;
import org.cboard.cboardservice.dataproviders.elasticsearch.query.QueryBuilder;
import org.cboard.cboardservice.util.json.JSONBuilder;
...
import static org.cboard.cboardservice.dataproviders.elasticsearch.aggregation.AggregationBuilder.dateHistAggregation;
import static org.cboard.cboardservice.dataproviders.elasticsearch.aggregation.AggregationBuilder.termsAggregation;
import static org.cboard.cboardservice.dataproviders.elasticsearch.query.QueryBuilder.*;
import static org.cboard.cboardservice.util.SqlMethod.coalesce;
import static org.cboard.cboardservice.util.json.JSONBuilder.json;
