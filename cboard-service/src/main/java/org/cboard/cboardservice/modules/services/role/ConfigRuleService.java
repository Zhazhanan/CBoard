package org.cboard.cboardservice.modules.services.role;
...
import org.cboard.cboardservice.modules.dao.*;
import org.cboard.cboardservice.modules.pojo.DashboardRole;
...
public class ConfigRuleService {
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.WidgetService.save(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.WidgetService.update(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.WidgetService.delete(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.DatasetService.save(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.DatasetService.update(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.DatasetService.delete(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.DatasourceService.save(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.DatasourceService.update(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.DatasourceService.delete(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.BoardService.save(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.BoardService.update(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.BoardService.delete(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.CategoryService.save(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.CategoryService.update(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.CategoryService.delete(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.AdminSerivce.addUser(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.AdminSerivce.updateUser(..)))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.AdminSerivce.addRole(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.AdminSerivce.updateRole(..)) || " +
            "execution(* org.cboard.cboardservice.modules.services.AdminSerivce.updateRoleRes(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.AdminSerivce.updateRole(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.AdminSerivce.updateUserRole(..)) ||" +
            "execution(* org.cboard.cboardservice.modules.services.AdminSerivce.deleteUserRoles(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.AdminSerivce.updateRoleResUser(..))")
