...
public class WidgetRoleService {
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.WidgetService.update(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.WidgetService.delete(..))")
