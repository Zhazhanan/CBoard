...
public class DatasourceRoleService {
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.DatasourceService.update(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.DatasourceService.delete(..))")
