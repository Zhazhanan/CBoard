...
public class DatasetRoleService {
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.DatasetService.update(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.DatasetService.delete(..))")
