...
public class JobRoleService {
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.job.JobService.update(..))")
    ...
    @Around("execution(* org.cboard.cboardservice.modules.services.job.JobService.delete(..))")
